# Generated by Django 2.0.5 on 2018-05-28 12:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ManyToManyField(blank=True, null=True, related_name='game_list_user', to='mycode.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Ball',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_latitude', models.FloatField(default=0.0, max_length=100, verbose_name='经度')),
                ('game_longitude', models.FloatField(default=0.0, max_length=100, verbose_name='纬度')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('club_slogan', models.CharField(default='', max_length=255, verbose_name='口号')),
                ('club_desc', models.CharField(default='', max_length=255, verbose_name='介绍')),
                ('club_title', models.CharField(default='', max_length=255, verbose_name='介绍')),
                ('club_post', models.ImageField(blank=True, default='user1.jpg', null=True, upload_to='images/club')),
                ('club_grade', models.IntegerField(default=1)),
                ('club_project', models.CharField(default='', max_length=255, verbose_name='项目介绍')),
                ('club_number', models.IntegerField(default=0)),
                ('club_ball', models.ManyToManyField(blank=True, to='mycode.Ball')),
                ('club_manager', models.ManyToManyField(blank=True, related_name='_gameclub_club_manager_+', to='mycode.Account')),
                ('club_user', models.ManyToManyField(blank=True, related_name='_gameclub_club_user_+', to='mycode.Account')),
                ('user', models.ManyToManyField(blank=True, related_name='_gameclub_user_+', to='mycode.Account')),
            ],
        ),
    ]
